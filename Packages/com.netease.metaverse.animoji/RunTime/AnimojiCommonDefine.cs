...
{
    public static class AnimojiConst
    {
        public const int c_unityExpressionSize = 67;
        public const int c_nativeExpressionSize = 59;
        public const int c_bboxSize = 4;
    }

    public enum AnimojiEuler
    {
        // ÉÏÏÂ
        Pitch = 0,
        // ×óÓÒ
    ...
    public class FaceBlendShapeDefine
    {
        //
        ...
        public static int ShapeIndexCount = 52;
    }
}