...
{
    public static class BlendShapeUtil
    {
        /// <summary>
        ...
        public static FaceBlendShapeDefine.FaceBlendShape GetLocation(string locationName)
        {
            return (FaceBlendShapeDefine.FaceBlendShape)Enum.Parse(typeof(FaceBlendShapeDefine.FaceBlendShape), locationName);
        }
