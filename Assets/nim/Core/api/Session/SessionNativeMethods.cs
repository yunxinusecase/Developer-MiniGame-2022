...
namespace NIM.Session
{
    ...
    [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
    internal delegate int NimSessionBadgeCountCbFunc([MarshalAs(UnmanagedType.CustomMarshaler, MarshalTypeRef = typeof(Utf8StringMarshaler))] string json_extension,
        IntPtr user_data);
#endif
    [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
...
#region NIM C SDK native methods
...
#if  !NIMAPI_UNDER_WIN_DESKTOP_ONLY
        [DllImport(NIM.NativeConfig.NIMNativeDLL, EntryPoint = "nim_session_reg_badge_count_cb", CharSet = CharSet.Ansi, CallingConvention = CallingConvention.Cdecl)]
        internal static extern void nim_session_reg_badge_count_cb(
            [MarshalAs(UnmanagedType.CustomMarshaler, MarshalTypeRef = typeof (Utf8StringMarshaler))] string json_extension,
            NimSessionBadgeCountCbFunc cb, IntPtr user_data);
#endif
        ...
        internal static extern void nim_session_set_extend_data(NIMSessionType to_type,
            ...
            IntPtr user_data);
#else
        [DllImport(NIM.NativeConfig.NIMNativeDLL, EntryPoint = "nim_session_get_all_unread_count", CharSet = CharSet.Ansi, CallingConvention = CallingConvention.Cdecl)]
        internal static extern uint nim_session_get_all_unread_count([MarshalAs(UnmanagedType.CustomMarshaler, MarshalTypeRef = typeof(Utf8StringMarshaler))]string json_extension);
#endif
