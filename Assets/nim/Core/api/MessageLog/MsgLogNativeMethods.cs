...
namespace NIM.Messagelog
{
    ...
    {
        [DllImport(NIM.NativeConfig.NIMNativeDLL, EntryPoint = "nim_msglog_query_msg_by_id_async", CharSet = CharSet.Ansi, CallingConvention = CallingConvention.Cdecl)]
        ...
        [DllImport(NIM.NativeConfig.NIMNativeDLL, EntryPoint = "nim_msglog_query_msg_async", CharSet = CharSet.Ansi, CallingConvention = CallingConvention.Cdecl)]
        ...
        [DllImport(NIM.NativeConfig.NIMNativeDLL, EntryPoint = "nim_msglog_query_msg_online_async", CharSet = CharSet.Ansi, CallingConvention = CallingConvention.Cdecl)]
        ...
        [DllImport(NIM.NativeConfig.NIMNativeDLL, EntryPoint = "nim_msglog_query_msg_by_options_async", CharSet = CharSet.Ansi, CallingConvention = CallingConvention.Cdecl)]
        ...
        [DllImport(NIM.NativeConfig.NIMNativeDLL, EntryPoint = "nim_msglog_batch_status_read_async", CharSet = CharSet.Ansi, CallingConvention = CallingConvention.Cdecl)]
        ...
        [DllImport(NIM.NativeConfig.NIMNativeDLL, EntryPoint = "nim_msglog_set_status_async", CharSet = CharSet.Ansi, CallingConvention = CallingConvention.Cdecl)]
        ...
        [DllImport(NIM.NativeConfig.NIMNativeDLL, EntryPoint = "nim_msglog_set_sub_status_async", CharSet = CharSet.Ansi, CallingConvention = CallingConvention.Cdecl)]
        ...
        [DllImport(NIM.NativeConfig.NIMNativeDLL, EntryPoint = "nim_msglog_insert_msglog_async", CharSet = CharSet.Ansi, CallingConvention = CallingConvention.Cdecl)]
        ...
        [DllImport(NIM.NativeConfig.NIMNativeDLL, EntryPoint = "nim_msglog_batch_status_delete_async", CharSet = CharSet.Ansi, CallingConvention = CallingConvention.Cdecl)]
        internal static extern void nim_msglog_batch_status_delete_async([MarshalAs(UnmanagedType.CustomMarshaler, MarshalTypeRef = typeof(NimUtility.Utf8StringMarshaler))] string account_id, NIMSessionType to_type, [MarshalAs(UnmanagedType.CustomMarshaler, MarshalTypeRef = typeof(NimUtility.Utf8StringMarshaler))] string json_extension, OperateMsglogByObjectIdDelegate cb, IntPtr user_data);

        [DllImport(NIM.NativeConfig.NIMNativeDLL, EntryPoint = "nim_msglog_delete_by_session_type_async", CharSet = CharSet.Ansi, CallingConvention = CallingConvention.Cdecl)]
        ...
        [DllImport(NIM.NativeConfig.NIMNativeDLL, EntryPoint = "nim_msglog_delete_async", CharSet = CharSet.Ansi, CallingConvention = CallingConvention.Cdecl)]
        ...
        [DllImport(NIM.NativeConfig.NIMNativeDLL, EntryPoint = "nim_msglog_delete_all_async", CharSet = CharSet.Ansi, CallingConvention = CallingConvention.Cdecl)]
        ...
        [DllImport(NIM.NativeConfig.NIMNativeDLL, EntryPoint = "nim_msglog_export_db_async", CharSet = CharSet.Ansi, CallingConvention = CallingConvention.Cdecl)]
        ...
        [DllImport(NIM.NativeConfig.NIMNativeDLL, EntryPoint = "nim_msglog_import_db_async", CharSet = CharSet.Ansi, CallingConvention = CallingConvention.Cdecl)]
        ...
        [DllImport(NIM.NativeConfig.NIMNativeDLL, EntryPoint = "nim_msglog_query_be_readed", CharSet = CharSet.Ansi, CallingConvention = CallingConvention.Cdecl)]
        ...
        [DllImport(NIM.NativeConfig.NIMNativeDLL, EntryPoint = "nim_msglog_send_receipt_async", CharSet = CharSet.Ansi, CallingConvention = CallingConvention.Cdecl)]
        ...
        [DllImport(NIM.NativeConfig.NIMNativeDLL, EntryPoint = "nim_msglog_reg_status_changed_cb", CharSet = CharSet.Ansi, CallingConvention = CallingConvention.Cdecl)]
