...
namespace NIM
{
...
#if UNITY_ANDROID && !UNITY_EDITOR
    public delegate void SendLocalPushNotificationDelegate(NIMReceivedMessage receivedMsg);
#endif
    ...
    public class TalkAPI
    {
        ...
        static SendLocalPushNotificationDelegate _sendLocalPushNotificationCallback = null;
        public static void SetSendLocalPushNotificationCallback(SendLocalPushNotificationDelegate callback)
        {
            _sendLocalPushNotificationCallback = callback;
        }
#endif
